...
lazy_static::lazy_static! {
    pub static ref ORG: RwLock<String> = RwLock::new("eu.bertcloud".to_owned());
}
...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("BertDesk".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["desk.bertcloud.eu"];
pub const RS_PUB_KEY: &str = "bGiMEFwkkOhKQa8bkvsnhhQCLmOenfr6RxJVvsbPBsk=";
